...
I18N.en = {
    ...
    'detail.moveInLeft': 'Left',
    'detail.moveInToday': 'Today',
    'detail.moveInPast': 'Date passed',
    'detail.moveInOneDay': '1 day',
    'detail.moveInDays': '{count} days',
    'detail.type': 'Type',
    ...
    'profile.roleLabel': 'Primary role',
    'profile.roleTenant': 'Tenant',
    'profile.roleLandlord': 'Landlord',
    'profile.roleAdmin': 'Admin',
    'profile.roleManager': 'Manager',
    ...
    'profile.errorNameRequired': 'Enter your name or nickname',
    'profile.errorLookingNumbers': 'Check the year, age, and budget fields.',
    ...
    'profile.looking.title': "What I'm looking for",
    'profile.looking.subtitle': 'Used to better match you with roommates',
    'profile.looking.roommateGender': 'Preferred roommate gender',
    'profile.looking.anyGender': 'Any',
    'profile.looking.birthYear': 'Your year of birth',
    'profile.looking.birthYearHint': 'e.g. 2000',
    'profile.looking.ageRange': 'Preferred roommate age',
    'profile.looking.budgetRange': 'Your monthly budget',
    'profile.looking.from': 'From',
    'profile.looking.to': 'To',
    'profile.looking.budgetOverlap': 'Budgets must overlap',
    'profile.looking.dealbreakers': 'Dealbreakers',
    'profile.looking.dealbreakersHint': 'Non-negotiable — a mismatch here drops the match',
    'profile.looking.priorities': 'Top priorities',
    'profile.looking.prioritiesHint': 'Weighted more heavily (up to 3)',
    'profile.looking.dimSleep': 'Sleep schedule',
