...
I18N.ru = {
    ...
    'detail.moveInLeft': 'Осталось',
    'detail.moveInToday': 'Сегодня',
    'detail.moveInPast': 'Дата прошла',
    'detail.moveInOneDay': '1 день',
    'detail.moveInDays': '{count} дней',
    'detail.type': 'Тип',
    ...
    'detail.group.openChat': 'Открыть групповой чат',
    'chat.title': 'Групповой чат',
    'chat.empty': 'Пока нет сообщений. Напишите первым.',
    'chat.placeholder': 'Сообщение',
    'chat.send': 'Отправить',
    'chat.error': 'Не удалось загрузить чат. Попробуйте ещё раз.',
    'chat.sendError': 'Не удалось отправить. Попробуйте ещё раз.',
    'chat.accessDenied': 'Нет доступа к этому чату.',
    'chat.listingCard': 'Объявление',
    'chat.members': '{count} чел.',
    'chat.replyingTo': 'Ответ для {name}',
    'chat.replyCancel': 'Отменить ответ',
    'account.groupChats': 'Групповые чаты',
    'account.groupChatPreview': 'Открыть чат',
    ...
    'filter.gender.male': 'Парень',
    'filter.gender.female': 'Девушка',
    ...
    'create.clearStationSelection': 'Сбросить выбранные станции',
    ...
    'account.hideConfirm': 'Скрыть это объявление? Оно больше не будет видно в поиске.',
    'account.showConfirm': 'Снова показать это объявление?',
    'account.visibilityError': 'Не удалось изменить видимость объявления. Попробуйте ещё раз.',
    ...
    'account.removeFromGroupBody': '{name} потеряет доступ к групповому чату. Освободится место для нового участника.',
    'account.removeReasonLabel': 'Причина удаления (необязательно)',
    'account.removeReason.inactive': 'Неактивен',
    'account.removeReason.rules': 'Нарушение правил',
    'account.removeReason.notFit': 'Не подходит группе',
    'account.removeReason.requested': 'По просьбе участника',
    'account.removeReason.other': 'Другое',
    'account.removeCancel': 'Отмена',
    'account.removeConfirm': 'Удалить из группы',
    ...
    'profile.roleLabel': 'Основная роль',
    'profile.roleTenant': 'Арендатор',
    'profile.roleLandlord': 'Арендодатель',
    'profile.roleAdmin': 'Админ',
    'profile.roleManager': 'Менеджер',
    ...
    'profile.errorNameRequired': 'Укажите имя или никнейм',
    'profile.errorLookingNumbers': 'Проверьте год рождения, возраст и бюджет.',
    ...
    'profile.looking.title': 'Что я ищу',
    'profile.looking.subtitle': 'Поможет точнее подобрать соседей',
    'profile.looking.roommateGender': 'Желаемый пол соседа',
    'profile.looking.anyGender': 'Любой',
    'profile.looking.birthYear': 'Ваш год рождения',
    'profile.looking.birthYearHint': 'напр. 2000',
    'profile.looking.ageRange': 'Желаемый возраст соседа',
    'profile.looking.budgetRange': 'Ваш бюджет в месяц',
    'profile.looking.from': 'От',
    'profile.looking.to': 'До',
    'profile.looking.budgetOverlap': 'Бюджеты должны совпадать',
    'profile.looking.dealbreakers': 'Неприемлемо',
    'profile.looking.dealbreakersHint': 'Принципиально — несовпадение резко снижает совместимость',
    'profile.looking.priorities': 'Главные приоритеты',
    'profile.looking.prioritiesHint': 'Учитываются сильнее (до 3)',
    'profile.looking.dimSleep': 'Режим сна',
