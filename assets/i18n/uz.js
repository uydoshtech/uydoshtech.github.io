...
I18N.uz = {
    ...
    'detail.moveInLeft': 'Qoldi',
    'detail.moveInToday': 'Bugun',
    'detail.moveInPast': 'Sana o‘tgan',
    'detail.moveInOneDay': '1 kun',
    'detail.moveInDays': '{count} kun',
    'detail.type': 'Turi',
    ...
    'chat.replyCancel': 'Javobni bekor qilish',
    ...
    'create.clearStationSelection': 'Tanlangan bekatlarni tozalash',
    ...
    'account.hideConfirm': 'Bu e’lonni yashirasizmi? U qidiruvda ko‘rinmaydi.',
    'account.showConfirm': 'Bu e’lonni qayta ko‘rsatamizmi?',
    'account.visibilityError': 'E’lon ko‘rinishini o‘zgartirib bo‘lmadi. Qayta urinib ko‘ring.',
    ...
    'account.removeFromGroupBody': '{name} guruh chatiga kirishni yo‘qotadi. Yangi ishtirokchi uchun joy ochiladi.',
    'account.removeReasonLabel': 'Chiqarish sababi (ixtiyoriy)',
    'account.removeReason.inactive': 'Faol emas',
    'account.removeReason.rules': 'Qoidalarni buzish',
    'account.removeReason.notFit': 'Guruhga mos emas',
    'account.removeReason.requested': 'Ishtirokchi iltimosiga ko‘ra',
    'account.removeReason.other': 'Boshqa',
    'account.removeCancel': 'Bekor qilish',
    'account.removeConfirm': 'Guruhdan chiqarish',
    ...
    'profile.roleLabel': 'Asosiy rol',
    'profile.roleTenant': 'Ijarachi',
    'profile.roleLandlord': 'Ijaraga beruvchi',
    'profile.roleAdmin': 'Admin',
    'profile.roleManager': 'Menejer',
    ...
    'profile.errorNameRequired': 'Ism yoki taxallus kiriting',
    'profile.errorLookingNumbers': 'Tug‘ilgan yil, yosh va byudjet maydonlarini tekshiring.',
    ...
    'profile.looking.title': 'Men nimani qidiryapman',
    'profile.looking.subtitle': 'Sizni hamxonalar bilan yaxshiroq moslashtirishga yordam beradi',
    'profile.looking.roommateGender': 'Hamxona jinsi (afzal)',
    'profile.looking.anyGender': 'Farqi yo‘q',
    'profile.looking.birthYear': 'Tug‘ilgan yilingiz',
    'profile.looking.birthYearHint': 'masalan, 2000',
    'profile.looking.ageRange': 'Hamxonaning afzal yoshi',
    'profile.looking.budgetRange': 'Oylik byudjetingiz',
    'profile.looking.from': 'Dan',
    'profile.looking.to': 'Gacha',
    'profile.looking.budgetOverlap': 'Byudjetlar mos kelishi shart',
    'profile.looking.dealbreakers': 'Murosasiz shartlar',
    'profile.looking.dealbreakersHint': 'Mos kelmasa, moslik keskin pasayadi',
    'profile.looking.priorities': 'Asosiy ustuvorliklar',
    'profile.looking.prioritiesHint': 'Kuchliroq hisobga olinadi (3 tagacha)',
    'profile.looking.dimSleep': 'Uyqu tartibi',
    'compat.title': 'Moslik',
