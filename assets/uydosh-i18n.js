...
const I18N = {
  uz: {
    ...
    'create.findNearbyMetro': 'Yaqin metro bekatlarini topish',
  ...
  ru: {
    ...
    'create.findNearbyMetro': 'Найти станции метро рядом',
  ...
  en: {
    ...
    'create.findNearbyMetro': 'Find nearby metro stations',
