...
const I18N = {
  uz: {
    ...
    'create.useCurrentLocation': 'Joriy joylashuvni aniqlash',
    ...
    'create.nearbyStationsEmpty': '15 daqiqalik piyoda masofada metro bekati topilmadi',
  ...
  ru: {
    ...
    'create.useCurrentLocation': 'Определить местоположение',
    ...
    'create.nearbyStationsEmpty': 'В радиусе 15 минут пешком станций метро нет',
  ...
  en: {
    ...
    'create.nearbyStationsEmpty': 'No metro stations within a 15-minute walk',
